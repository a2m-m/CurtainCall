...
## Next actions
1. PR #143 マージ後、バグ修正 #131（暫定スコアの情報漏洩バグ）へ着手推奨
2. UX改善は #135→#136（スカウト結果・lastScoutedCard）が他に依存されるため先行推奨
