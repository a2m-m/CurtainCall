...
## Status
Issue #119・#120 完了。オープン Issue なし。次の機能 Issue 起票待ち。

## Active Issues
- #128 [Bug] ブーイング失敗時にセットオープンの操作プレイヤーが切り替わらない
- #129 [Bug] セットオープンの結果（引いたカード）が画面に表示されない
