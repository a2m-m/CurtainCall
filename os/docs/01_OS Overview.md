...
AI（Claude Code / Codex / Antigravity）× GitHub を前提に、速度と安全性を両立しながら、学習も自然に生まれる開発エコシステムを作る。
...
# **4\. 役割分担（Claude Code / Codex / Antigravity / GitHub）**

## **4.1 QA/Architect & Reviewer（例：Claude Code / Codex）**
